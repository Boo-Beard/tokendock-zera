  ...
  const verifiedInlineHtml = verified && vStyle === 'inline'
    ? (function(){
        ...
        return '<span class="verified-inline" style="display:inline-flex;align-items:center;">'
             + '<i class="fa-solid fa-circle-check info-icon" style="color: var(--verified-color, #009bff); font-size:0.9em; margin-left:-6px;" data-info="' + infoText.replace(/"/g,'&quot;') + '" aria-label="Verified" role="img"></i>'
             + '</span>';
      })()
    : '';
